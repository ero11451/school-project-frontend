...
export default function DashboardLayout({ sideNavList }: { sideNavList: sidebarInterface[] }) {
  return (
    <div>
 ...
 ">
        ...
        <nav className="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
          <ul className="space-y-1.5">
            ...
            {sideNavList.map((nav: sidebarInterface) => <li key={nav.key} className="flex flex-col">
              <NavLink
                to={nav.path}
