            ...
            >
              <motion.div layoutId={`image-${active.title}-${id}`}>
                <img
                  width={200}
                  height={200}
                  src={active.src || active.thumbnailUrl}
                  alt={active.title}
              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  <div className="">
                    ...
                    >
                      {active.title || active.courseName}
                    </motion.h3>
                    <motion.p
                    ...
                    >
                      ...
                      <div className="lowercase mt-2">
                        <p>created by: {active?.creator?.userName}</p>
                        <p>email: {active?.creator?.email}</p>
                      </div>
