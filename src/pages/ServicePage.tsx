      ...
      <div className="max-w-5xl px-4 xl:px-0 lg:py-10 lg:pt-5  mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
          <div className="aspect-w-16 aspect-h-9 lg:aspect-none">
            <img loading="lazy"  className="w-full object-cover rounded-xl" src="https://images.unsplash.com/photo-1587614203976-365c74645e83?q=80&amp;w=480&amp;h=600&amp;auto=format&amp;fit=crop&amp;ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Features Image" />
          </div>
          ...
          <div>
            ...
            <div className="flex gap-x-5 ms-1">
              ...
              <div className="grow pt-0.5 pb-8 sm:pb-12">
                <p className="text-sm lg:text-base text-neutral-400">
                  <span className="dark:text-white">Market Research and Analysis:</span>
            ...
            <div className="flex gap-x-5 ms-1">
              ...
              <div className="grow pt-0.5 pb-8 sm:pb-12">
                <p className="text-sm lg:text-base text-neutral-400">
                  <span className="dark:text-white">Product Development and Testing:</span>
            ...
            <div className="flex gap-x-5 ms-1">
              ...
              <div className="grow pt-0.5 pb-8 sm:pb-12">
                <p className="text-sm md:text-base text-neutral-400">
                  <span className="dark:text-white">Marketing and Promotion:</span>
            ...
            <div className="flex gap-x-5 ms-1">
              ...
              <div className="grow pt-0.5 pb-8 sm:pb-12">
                <p className="text-sm md:text-base text-neutral-400">
                  <span className="dark:text-white">Launch and Optimization:</span>
            ...
            <a className="group inline-flex items-center gap-x-2 py-2 px-3 bg-lime-400 font-medium text-sm text-neutral-800 rounded-full focus:outline-none" href="#">
              <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" >
