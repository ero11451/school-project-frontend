            ...
            <div className="max-w-[75rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                <div className="text-center lg:p-10">
                    <button type="button" className="btn w-fit "></button>
                        <p className='font-[600]  lg:text-[32px] text-transparent bg-clip-text bg-gradient-to-r from-[#163930] via-green-900 to-[#3D9F86] animate-gradient'>Powerful Dev Tools to Bring Your Ideas to Life</p>
                    <p className='lg:px-60 text-sm' >Access cutting-edge development tools and resources to streamline your workflow and  build exceptional digital products</p>
                </div>
