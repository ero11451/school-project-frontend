                    ...
                    <div className="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                        <nav className="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                            <ul className="flex flex-col space-y-1" data-hs-scrollspy="#scrollspy">
                                ...
                                <li>
                                    <a className="p-2 flex items-center gap-x-3.5 text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 hs-scrollspy-active:bg-gray-100 dark:hs-scrollspy-active:bg-neutral-700" href="#account">
                                ...
                                <li>
                                    <a className="p-2 flex items-center gap-x-3.5 text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 hs-scrollspy-active:bg-gray-100 dark:hs-scrollspy-active:bg-neutral-700" href="#projects">
                                ...
                                <li>
                                    <a className="p-2 flex items-center gap-x-3.5 text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 hs-scrollspy-active:bg-gray-100 dark:hs-scrollspy-active:bg-neutral-700" href="#calendar">
                                ...
                                <li>
                                    <a className="p-2 flex items-center gap-x-3.5 text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 hs-scrollspy-active:bg-gray-100 dark:hs-scrollspy-active:bg-neutral-700" href="#documentation">
...
{children}
                    {/* <div id="scrollspy" className="space-y-10 md:space-y-16">
                        ...
                        <div id="documentation" className="min-h-[25rem] scroll-mt-24">
                            <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Documentation</h2>
                        </div>

                        <div id="first" className="min-h-[25rem] scroll-mt-24">
                            <h2 className="text-lg font-semibold text-gray-800 dark:text-white">First</h2>
                        </div>

                        <div id="second" className="min-h-[25rem] scroll-mt-24">
                            <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Second</h2>
                        </div>

                        <div id="third" className="min-h-[25rem] scroll-mt-24">
                            <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Third</h2>
                        </div>
                    </div> */}
                </div>
            </div>
