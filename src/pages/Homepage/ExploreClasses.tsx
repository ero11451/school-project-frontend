                ...
                <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-1 ">
                    <div className="relative mx-auto max-w-5xl grid space-y-5 sm:space-y-10">
                        ...
                        <div className="grid  lg:grid-cols-1 items-center gap-6 md:gap-10 ">
                            ...
                            <div className="size-full   p-5 dark:bg-neutral-900 text-center">

                                <div className="shrink-0">
                                    <h3 className="block text-[22px] font-[600] 0 dark:text-white ">Explore classes from Neeboh</h3>
                                </div>

                                <p className="font-[100] text-[18px] my-2 lg:px-32">
                           ...
                           <div className='w-screen'>
                                <div className="flex space-x-4 overflow-x-scroll scrollbar-hide">
                                    ...
                                    {[1, 1, 1, 1, 1].map(() => <a className="group bg-white flex flex-col min-w-[350px] min-h-[350px] border border-gray-200 hover:border-transparent hover:shadow-lg focus:outline-none focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl p-5 dark:border-neutral-700 dark:hover:border-transparent dark:hover:shadow-black/40 dark:focus:border-transparent dark:focus:shadow-black/40 " >
                            ...
                            <div className="lg:p-5  text-center">
                                ...
                                <p className="font-[100] lg:text-[18px] lg:my-2 lg:px-32">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet habitant dui consectetur sed nam amet, magna. Iet se
                                </p>
                            </div>
                            ...
                            <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                                ...
                                <div className='lg:flex lg:flex-col lg:gap-10'>
                                    ...
                                    <p className=" font-[400] text-[14px] text-[#333333] font-[400]  border-l-2 border-[#E5951A] lg:p-5">
                                    ...
                                    <div>
                                        ...
                                        <p className='text-[#828282] font-[200] text-[14px]'>Facility manager</p>
                                    </div>
                                </div>
                            </div>
                        </div>
