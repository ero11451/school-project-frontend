        ...
        <main id="content">
          ...
          <div className="sticky top-0 inset-x-0 z-20 bg-white border-y px-4 sm:px-6 lg:px-8  dark:bg-neutral-800 dark:border-neutral-700">
            <div className="flex items-center py-2">
              ...
              <button type="button" className="size-8 flex bg-green-900 text-white justify-center items-center gap-x-2 border border-gray-200 text-gray-800 hover:text-white rounded-lg focus:outline-none focus:text-gray-500 disabled:opacity-50 disabled:pointer-events-none dark:border-neutral-700 dark:text-neutral-200 dark:hover:text-neutral-500 dark:focus:text-neutral-500" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-application-sidebar" aria-label="Toggle navigation" data-hs-overlay="#hs-application-sidebar">
                <span className="sr-only">Toggle Navigation</span>
                <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" /><path d="M15 3v18" /><path d="m8 9 3 3-3 3" /></svg>
              </button>
              ...
              <ol className="ms-3 flex items-center whitespace-nowrap">
               ...
               { selectedClass?.options && <ModelWithElement
                     onSave ={() => console.log("please log this user ")} 
                     title={selectedClass?.question || ""} 
                     btnStyle={"bg-green-300 p-2 text-sm ml-4"} 
                     btnText={"Take Assessment"}>
                         <Task  options={ selectedClass?.options } />
                </ModelWithElement>}
              </ol>
            </div>
          </div>
                    ...
                    {MainData?.map((classItem: Ipost) => <>
                      <li>
                        <button onClick={() => setSelectedClass(classItem)}
                          ...
                          <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" /><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" /></svg>
                          {classItem?.title}
                        </button>
                      </li>
                    </>)}
