  ...
  return (
    <div >
            <div className="max-w-7xl px-4 lg:px-6 lg:px-8 py-12 lg:py-2 mx-auto  dark:bg-neutral-900">
                    ...
                    <div className=" lg:grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">

                        <button className="group block"    onClick={() => navigate(RoutePath.videoDisplay)} >
                    ...
                    <div className="mt-10 lg:mt-20 text-center">
                        ...
                        dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white" href="#">
                            View all Work
                        </a>
                    </div>
                </div>
