...
export default function Footer() {
    return (
        <div>
            <footer className="relative  lg:flex lg:flex-col items-center">
                    ...
                    <div className="bg-[#E8EBEA]  rounded-lg border-8   border-white w-full max-w-[65rem]  mx-auto ">
                        <div className="lg:grid grid-cols-6 gap-6">
                            <div className="col-span-4 lg:p-10 p-5">
                                ...
                                <p className="lg:pr-100 lg:text-sm text-[10px] font-thin">
                                    Get expert help and skill development from the best in the industry. Our courses are designed to help you learn new skills and improve your career prospects.
                                </p>
                            </div>
