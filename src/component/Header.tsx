  ...
  return (
    <div className=" dark:bg-black bg-black ">
      ...
      <div className="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24 absolute lg:top-20 top-40 left-0 right-0 w-screen ">
        <h1 className="font-semibold text-white lg:text-5xl md:text-6xl text-2xl bg-black">
          <span className="text-lime-400 bg-black">Neeboh:</span> Transforming ideas into reality
        </h1>
        ...
        <div className="relative z-10">
          <div className="max-w-5xl px-4 xl:px-0 mx-auto mt-10">
            <div className="mb-4">
              <h2 className="text-neutral-400">Trusted by users  and more than 99,000 of you</h2>
            </div>

            <div className="flex justify-between gap-6">
              <div>
                <img src="icon/library.png" className="py-3 lg:py-5 w-16 h-auto md:w-20  lg:w-24 text-white " />
              </div>
         
              <svg className="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-neutral-400" enable-background="new 0 0 2499 614" viewBox="0 0 2499 614" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg className="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-neutral-400" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 88 22" enable-background="new 0 0 88 22">
